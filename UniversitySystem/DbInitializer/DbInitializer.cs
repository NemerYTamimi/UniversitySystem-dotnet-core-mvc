...
namespace UniversitySystem.DbInitializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initalize()
        {
            ...
            _roleManager.CreateAsync(new IdentityRole(Helper.Teacher)).GetAwaiter().GetResult();
            _roleManager.CreateAsync(new IdentityRole(Helper.Student)).GetAwaiter().GetResult();
